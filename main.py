...
st.markdown('<h5 style="background-color: white; color: #40E0D0; border: 8px solid #000080; padding: 10px; text-align: center">This application is designed detects/classifies a SMS into SPAM or HAM (normal) based on the textual data using Natural Language Processing. </h5>', unsafe_allow_html=True)
